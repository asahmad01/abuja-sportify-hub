...
import { Apple, Play as GooglePlay } from "lucide-react";
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 bg-white/10 hover:bg-white/20 border border-white/20 text-white px-4 py-2.5 rounded-xl transition-all w-fit"
              >
                <GooglePlay className="w-5 h-5 flex-shrink-0" />
                <div className="text-left">
                  <div className="text-xs text-white/50 leading-none">Get it on</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <button onClick={() => document.getElementById('download-section')?.scrollIntoView({ behavior: 'smooth' })} className="text-white/50 hover:text-primary transition-colors text-sm">
                    Download App
                  </button>
                </li>
